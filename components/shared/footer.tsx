...
const Footer = () => {
    return (
        <footer className="mx-auto text-center mt-10">
            <div className="footerSocialMedia mb-5 text-center flex md:flex-cols md:w-1/12 justify-between mx-auto footerNav">
            ...
            <div className="md:flex flex-cols md:w-4/12 justify-between mx-auto text-center footerNav">
